...
HD_PWD='D:/Documents/Project/homework_1/homework_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FourBitFA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FourBitFA.tcl
