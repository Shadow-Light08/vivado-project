...
HD_PWD='D:/Documents/Project/Exp4/Exp4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log register_heap_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source register_heap_top.tcl -notrace
