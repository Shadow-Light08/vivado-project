...
HD_PWD='D:/Documents/Project/Exp4/Exp4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log register_heap_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source register_heap_top.tcl
