...
HD_PWD='D:/Documents/Project/homework_12/homework_12.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Aniti_Shake_Counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Aniti_Shake_Counter.tcl -notrace
