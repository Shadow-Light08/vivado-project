...
HD_PWD='D:/Documents/Project/homework_12/homework_12.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Aniti_Shake_Counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Aniti_Shake_Counter.tcl
