...
HD_PWD='D:/Documents/Project/homework_3/homework_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log C8_3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source C8_3.tcl -notrace
