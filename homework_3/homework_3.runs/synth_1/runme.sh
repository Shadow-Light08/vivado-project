...
HD_PWD='D:/Documents/Project/homework_3/homework_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log C8_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source C8_3.tcl
