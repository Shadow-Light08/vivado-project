...
HD_PWD='D:/Documents/Project/homework_8/homework_8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log D_74LS198.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source D_74LS198.tcl
