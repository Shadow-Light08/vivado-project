...
HD_PWD='D:/Documents/Project/homework_8/homework_8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log D_74LS198.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source D_74LS198.tcl -notrace
