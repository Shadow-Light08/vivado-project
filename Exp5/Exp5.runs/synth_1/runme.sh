...
HD_PWD='D:/Documents/Project/Exp5/Exp5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_mem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_mem.tcl
