...
HD_PWD='D:/Documents/Project/Exp5/Exp5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_mem.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_mem.tcl -notrace
