...
HD_PWD='D:/Documents/Project/Exp10/Exp10.runs/RAM_Data_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RAM_Data.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RAM_Data.tcl
