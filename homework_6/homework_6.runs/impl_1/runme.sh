...
HD_PWD='D:/Documents/Project/homework_6/homework_6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log J_K_74LS76.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source J_K_74LS76.tcl -notrace
