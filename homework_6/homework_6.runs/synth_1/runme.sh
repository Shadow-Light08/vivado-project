...
HD_PWD='D:/Documents/Project/homework_6/homework_6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log J_K_74LS76.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source J_K_74LS76.tcl
