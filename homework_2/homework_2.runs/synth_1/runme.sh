...
HD_PWD='D:/Documents/Project/homework_2/homework_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log E3_8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source E3_8.tcl
