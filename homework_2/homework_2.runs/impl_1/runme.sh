...
HD_PWD='D:/Documents/Project/homework_2/homework_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log E3_8.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source E3_8.tcl -notrace
