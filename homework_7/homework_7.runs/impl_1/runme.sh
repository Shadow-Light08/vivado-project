...
HD_PWD='D:/Documents/Project/homework_7/homework_7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log D_D.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source D_D.tcl -notrace
