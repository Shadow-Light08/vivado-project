...
HD_PWD='D:/Documents/Project/homework_7/homework_7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log D_D.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source D_D.tcl
