...
HD_PWD='D:/Documents/Project/homework_9/homework_9.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Timers.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Timers.tcl
