...
HD_PWD='D:/Documents/Project/homework_9/homework_9.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Timers.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Timers.tcl -notrace
